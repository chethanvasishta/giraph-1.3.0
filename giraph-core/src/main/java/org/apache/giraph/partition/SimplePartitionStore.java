...
public class SimplePartitionStore<I extends WritableComparable,
  ...
  /**GRAPHITE */
  @Override
  public RangeMap<Integer, Integer> getPartitionIntervalVertexCount(Integer partitionId) {
    Partition partition = partitions.get(partitionId);
    if (partition == null) {
      return null;
    } else {
    	RangeMap<Integer, Integer> numOfIntervalVertices = partition.getIntervalVertexCount();
