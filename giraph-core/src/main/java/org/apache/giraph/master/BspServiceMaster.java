...
public class BspServiceMaster<I extends WritableComparable,
  ...
  private SuperstepClasses prepareMasterCompute(long superstep) {
    GraphState graphState = new GraphState(superstep ,
        ...
        GiraphStats.getInstance().getIntervalVertexCount(),
        getContext());
    SuperstepClasses superstepClasses =
  ...
  KeeperException, InterruptedException {
    ...
    /**GRAPHITE */
    if(getCachedNumOfIntervalVertices()==null) {
    	setCachedNumOfIntervalVertices(globalStats.getIntervalVertexCount());
    } else {
    	globalStats.setIntervalVertexCount(getCachedNumOfIntervalVertices());
    }
  ...
  private void updateCounters(GlobalStats globalStats) {
    ...
    /**GRAPHITE */
    gs.setIntervalVertexCount(globalStats.getIntervalVertexCount());
  }
}
