...
public abstract class BspService<I extends WritableComparable,
  ...
  private RangeMap<Integer, Integer> cachedNumOfIntervalVertices;
  /**
   * Constructor.
   *
  ...
  public final void setCachedSuperstep(long superstep) {
    cachedSuperstep = superstep;
  	...
  	/**GRAPHITE */
	public RangeMap<Integer, Integer> getCachedNumOfIntervalVertices() {
		return this.cachedNumOfIntervalVertices;
	}

	/**GRAPHITE */
	public void setCachedNumOfIntervalVertices(RangeMap<Integer, Integer> cachedNumOfIntervalVertices) {
		this.cachedNumOfIntervalVertices = cachedNumOfIntervalVertices;
	}
