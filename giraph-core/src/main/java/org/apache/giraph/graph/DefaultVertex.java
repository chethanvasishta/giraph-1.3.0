 ...
 *
 * @param <I> Interval Vertex id
 * @param <T> Interval Time-Point Type
 * @param <S> Compute State Type
 * @param <V> Interval Vertex data
 * @param <E> Interval Edge data
 * @param <PW> Warpped Message Type
