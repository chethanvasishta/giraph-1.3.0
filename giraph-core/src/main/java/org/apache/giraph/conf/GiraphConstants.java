...
public interface GiraphConstants {
  ...
  /**
    ...
    */
   BooleanConfOption CONFIGURE_EXTRA_JAVA_OPTS =
       new BooleanConfOption("graphite.configureJavaOpts", false,
           "Whether to configure java opts");

   /**
    * Java options passed to mappers.
    */
   StrConfOption GRAPHITE_WORKER_JAVA_OPTIONS =
       new StrConfOption("graphite.worker.java.opts", null,
           "Java options passed to giraph workers");
